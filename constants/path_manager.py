...
DOCKER_ENGINE_MAKEFILE_PATH = 	Path(get_absolute_path('/buildroot/package/docker-engine/docker-engine.mk'))
DOCKER_CLI_MAKEFILE_PATH = 		Path(get_absolute_path('/buildroot/package/docker-cli/docker-cli.mk'))
...
SCRIPTS						= 	get_absolute_path('/scripts')